...
Application.create!(
  name: "Basecamp",
  description: "Basecamp is a cloud application that helps users manage projects and keep teams on the same page. Basecamp 3 is a system that enables users and companies to get organized, communicate with everyone easily, and collaborate on projects.",
...
Application.create!(
  ...
  description: "Artboard Studio is world's the first online graphic design application mainly focused on product mockups.",
